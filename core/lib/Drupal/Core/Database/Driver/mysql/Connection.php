...
class Connection extends DatabaseConnection {
  ...
  public static function open(array &$connection_options = []) {
    ...
    // by one.
    $txn_isolation = 'tx_isolation'; // https://www.drupal.org/files/issues/2021-03-23/1650930-109.patch by shakti 05-08-21
    $connection_options += [
      'init_commands' => [],
    ];
    $connection_options['init_commands'] += [
      ...
      'isolation' => "SET SESSION " . $txn_isolation . " = 'READ-COMMITTED'", // added this link as per above patch id 05-08-21    
    ];
